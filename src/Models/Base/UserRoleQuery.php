...
use basteyy\XzitGiggle\Models\Map\UserRoleTableMap;

/**
 * Base class that represents a query for the `xg_user_roles` table.
 *
 ...
 * @method     ChildUserRoleQuery orderByIdentifier($order = Criteria::ASC) Order by the identifier column
 *
 * @method     ChildUserRoleQuery groupById() Group by the id column
 * @method     ChildUserRoleQuery groupByName() Group by the name column
 * @method     ChildUserRoleQuery groupByIdentifier() Group by the identifier column
 *
 ...
 * @method     ChildUserRole|null findOneByIdentifier(string $identifier) Return the first ChildUserRole filtered by the identifier column
 *
 ...
 * @method     ChildUserRole requireOneByIdentifier(string $identifier) Return the first ChildUserRole filtered by the identifier column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildUserRole[]|Collection findByIdentifier(string|array<string> $identifier) Return ChildUserRole objects filtered by the identifier column
 * @psalm-method Collection&\Traversable<ChildUserRole> findByIdentifier(string|array<string> $identifier) Return ChildUserRole objects filtered by the identifier column
 *
...
abstract class UserRoleQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \basteyy\XzitGiggle\Models\Base\UserRoleQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\basteyy\\XzitGiggle\\Models\\UserRole', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `name`, `identifier` FROM `xg_user_roles` WHERE `id` = :p0';
        try {
    ...
    public function filterByIdentifier($identifier = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(UserRoleTableMap::COL_IDENTIFIER, $identifier, $comparison);
     ...
     *
     * @param \basteyy\XzitGiggle\Models\User|ObjectCollection $user the related object to use as filter
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByUsers($user, ?string $comparison = null)
    {
        if ($user instanceof \basteyy\XzitGiggle\Models\User) {
            $this
                ->addUsingAlias(UserRoleTableMap::COL_ID, $user->getUserRoleId(), $comparison);
