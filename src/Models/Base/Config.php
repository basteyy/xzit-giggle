...
/**
 * Base class that represents a row from the 'xg_config' table.
 *
 *
 *
...
abstract class Config implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\basteyy\\XzitGiggle\\Models\\Map\\ConfigTableMap';
    ...
    public function setDefault($v)
    {
        ...
        if ($this->default !== $v) {
            $this->default = $v;
            $this->modifiedColumns[ConfigTableMap::COL_DEFAULT] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ConfigTableMap::translateFieldName('Default', TableMap::TYPE_PHPNAME, $indexType)];
            $this->default = (null !== $col) ? (string) $col : null;
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(ConfigTableMap::COL_DEFAULT)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(ConfigTableMap::COL_DEFAULT)) {
            $criteria->add(ConfigTableMap::COL_DEFAULT, $this->default);
        }
        if ($this->isColumnModified(ConfigTableMap::COL_VALUE)) {
     ...
     * objects.
     *
     * @param object $copyObj An object of \basteyy\XzitGiggle\Models\Config (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \basteyy\XzitGiggle\Models\Config Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
