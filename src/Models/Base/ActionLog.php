...
/**
 * Base class that represents a row from the 'xg_action_log' table.
 *
 *
 *
...
abstract class ActionLog implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\basteyy\\XzitGiggle\\Models\\Map\\ActionLogTableMap';
    ...
    /**
     * Initializes internal state of basteyy\XzitGiggle\Models\Base\ActionLog object.
     * @see applyDefaults()
     */
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[ActionLogTableMap::COL_USER_ID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ActionLogTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ActionLogTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ActionLogTableMap::translateFieldName('Action', TableMap::TYPE_PHPNAME, $indexType)];
            $this->action = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ActionLogTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\basteyy\\XzitGiggle\\Models\\ActionLog'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(ActionLogTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(ActionLogTableMap::COL_ACTION)) {
            $modifiedColumns[':p' . $index++]  = '`action`';
        }
        if ($this->isColumnModified(ActionLogTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }

        $sql = sprintf(
            'INSERT INTO `xg_action_log` (%s) VALUES (%s)',
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(ActionLogTableMap::COL_USER_ID)) {
            $criteria->add(ActionLogTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(ActionLogTableMap::COL_ACTION)) {
            $criteria->add(ActionLogTableMap::COL_ACTION, $this->action);
        }
        if ($this->isColumnModified(ActionLogTableMap::COL_CREATED_AT)) {
            $criteria->add(ActionLogTableMap::COL_CREATED_AT, $this->created_at);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \basteyy\XzitGiggle\Models\ActionLog (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \basteyy\XzitGiggle\Models\ActionLog Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function getUser(?ConnectionInterface $con = null)
    {
        if ($this->aUser === null && ($this->user_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addActionLogss($this);
             */
        }
    ...
    {
        if (null !== $this->aUser) {
            $this->aUser->removeActionLogs($this);
        }
        $this->id = null;
        $this->user_id = null;
        $this->action = null;
