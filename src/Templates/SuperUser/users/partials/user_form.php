...
<form method="post">
    <div class="my-3">
        ...
        <input
                type="text" name="username" id="username" <?= $this->getUser()->getId() === $user->getId() ? 'disabled="disabled"' : '' ?>
    ...
    <div class="my-3">
        ...
        <input
                type="email" name="email" id="email" required placeholder="<?= __('E-Mail of the user') ?>"
                class="form-control" value="<?= $user->getEmail() ?? '' ?>">
    </div>
    <div class="my-3">
        <label for="user_role" class="form-label"><?= __('User role') ?></label>
        <select
                name="user_role" id="user_role" class="form-select" required aria-label="<?= __('Select the user role') ?>" <?= $this->getUser()->getId() ===
        $user->getId() ? 'disabled="disabled"' : '' ?>>
            <?php
            foreach (UserRoleQuery::create()->orderById(\Propel\Runtime\ActiveQuery\Criteria::DESC)->find() as $user_role) {
    ...
    <div class="my-3 form-check">
        <input
                class="form-check-input" type="checkbox" value="1" <?= $this->getUser()->getId() === $user->getId() ? 'disabled="disabled"' : '' ?>
    ...
    <div class="my-3 d-none" data-password-field>
        ...
        <input
                type="password" name="password" id="password" placeholder="<?= __('Password of the user') ?>"
                class="form-control">
    </div>
    ...
    <div class="my-3">
        ...
        <input
                type="text" name="home_folder" id="home_folder" required class="form-control"
    ...
    <div class="my-3">
        ...
        <input
                type="text" name="log_folder" id="log_folder" required class="form-control"
    ...
    <div class="my-3">
        ...
        <input
                type="text" name="web_folder" id="web_folder" required class="form-control"
    ...
    <div class="my-3">
        ...
        <input
                type="text" name="bash" id="bash" required class="form-control"
    ...
    <div class="alert alert-info">
        The settings regarding php-fpm are domain specific. You can change them in the domain settings.
    </div>

    <div class="my-3 text-end">
        <button class="btn btn-primary" type="submit">
            <i class="bi bi-person-add"></i> <?= __('Save') ?>
        </button>
    </div>
</form>
